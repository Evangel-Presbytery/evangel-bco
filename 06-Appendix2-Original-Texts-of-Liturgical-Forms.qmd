...
<a id="sec-chapter-slug-1-calvins-service-of-the-lords-supper-1542-1566"></a>

<a id="sec-appendix2-1"></a>
...
<a id="sec-chapter-slug-2-the-form-of-solemnization-of-matrimony-1549-book-of-common-prayer"></a>
...
::: {.center data-latex=""}
*The new married persons (the same day of their marriage) must receive the holy communion.*[^appendix2.02]
:::

[^appendix2.02]: Original text from the 1549 Book of Common Prayer, with modernized spelling.

<a id="sec-chapter-slug-3-the-order-for-the-burial-of-the-dead-1549-book-of-common-prayer"></a>


## 3. The Order for the Burial of the Dead (1549 Book of Common Prayer) 

::: {.center data-latex=""}
<a id="sec-appendix2-3"></a>*The priest meeting the corpse at the church style, shalt say: Or else the priests and clerks shalt sing, and so go either into the church, or towards the grave,*
:::
