...
\tightlist
\item
  \textbf{Current version:} Amendments to BCO 6.3, 12.3 and 22.11 regarding the use of ``Teaching Elder''; amendment to BCO 12.3 regarding who is required to preach at presbytery; amendment inserting a new section 29 to the BCO (subsequent sections, and all internal links, were re-numbered as a result). These amendments were ratified at the presbytery meeting held on October 6, 2023.
\item
